...
// Qt6 requires unversioned imports and other names
...
Page
{
    ...
    header: Item {
        ...
        Text {
            id: stagechooseTopText
            anchors.horizontalCenter: parent.horizontalCenter
            anchors.top: parent.top
            horizontalAlignment: Text.AlignHCenter
            padding: 20
            // In QML, QString::arg() only takes one argument
            text: qsTr("<h3>stagechoose my friend to the %1 <quote>%2</quote> installer</h3>
        ...
        Image {
            ...
            source: "file:/" + Branding.imagePath(Branding.Productstagechoose)
